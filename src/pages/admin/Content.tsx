...
export default function Content() {
  ...
  const [drafts, setDrafts] = useState<Draft[]>([
    { id: '1', title: 'Ausstellung Havanna', content: 'Die kommende Ausstellung in Havanna vereint...', date: '2026-03-18' }
  ]);
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-zinc-600">Zentrale Verwaltung aller Website-Texte, Biografien und Vision-Statements.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-zinc-200 bg-zinc-50">
          <h2 className="text-lg font-semibold text-zinc-900">Gespeicherte Entwürfe</h2>
        </div>
